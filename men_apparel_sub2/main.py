...
# Hardcoded subcategory URLs for Men's Apparel - Group 2
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/apparel/kidswear-1/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/t-shirts-tanks/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/hoodies-sweatshirts/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/cardigans-sweaters/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/joggers-sweatpants/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/shorts/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Apparel Pipeline - Group 2 (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/apparel/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/apparel/excel-files"
            )
