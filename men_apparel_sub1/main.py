...
# Hardcoded subcategory URLs for Men's Apparel - Group 1
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/apparel/pajama-sets/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/fabrics-1917743944/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/dishdasha/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/shemagh-ghutra/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/polo-shirts/l/",
    "https://www.boutiqaat.com/ar-kw/men/apparel/shirts/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Apparel Pipeline - Group 1 (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
